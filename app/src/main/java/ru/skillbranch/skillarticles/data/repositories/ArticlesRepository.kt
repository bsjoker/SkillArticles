...
object ArticlesRepository {
    ...
    private fun searchArticlesByTitle(start: Int, size: Int, queryTitle: String) =
        local.localArticleItems
            .asSequence() // asSequence - более экономично по памяти
...
// вспомогательный класс, который объясняет page list'у, как создать LiveData из нашего DataSource
