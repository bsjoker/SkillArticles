...
//        .setMargins(left, top, right, bottom) к уже существующей View(а конкретно к NestedScrollView) применить никак нельзя и нужно ее как то вручную пересоздавать?
